      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-5">
        <div className="flex items-center justify-between h-14 sm:h-16">
          ...
          <div className="flex items-center gap-1.5 sm:gap-3">
            ...
            {formattedForeBalance && (
              <span className="hidden sm:inline-flex items-center px-3 py-2 bg-zinc-900/55 border border-zinc-800/70 rounded-xl text-xs font-medium text-cyan-200">
                {formattedForeBalance}
              </span>
            )}
      ...
      {menuOpen && (
        <div className="sm:hidden fixed inset-0 z-40" aria-hidden="true">
          ...
          <div className="absolute top-16 right-3 left-3 bg-zinc-950 border border-zinc-900/70 rounded-2xl shadow-[0_20px_60px_rgba(8,8,12,0.65)] p-4 space-y-4">
            ...
            {formattedForeBalance && (
              <div className="sm:hidden flex items-center justify-between bg-zinc-900/55 border border-zinc-800/70 rounded-xl px-4 py-3 text-sm text-zinc-100">
