      ...
      <div className="p-6 space-y-6">
        ...
        <div className="p-4 bg-zinc-900 border border-zinc-800 rounded-md">
          ...
          <div className="flex gap-2">
            ...
            <button className="flex-1 px-3 py-2 bg-zinc-950 border border-zinc-800 text-xs font-semibold">
              Withdraw
            </button>
          </div>
        </div>
  ...
  return (
    <button
      ...
      className={`w-full flex items-center space-x-3 px-4 py-3 text-sm font-semibold transition ${
        active
          ? "bg-zinc-900 border border-cyan-500 text-cyan-500 rounded-md"
          : "text-zinc-400 hover:text-white hover:bg-zinc-900 border border-transparent rounded-md"
      }`}
    >
      {icon}
      <span>{label}</span>
